...
(* OASIS_START *)
(* DO NOT EDIT (digest: d8213f99e2ea6741ec5a246ba481d1c4) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Nowadays most of the websites allowing their users to post content (articles, comments, etc.) allows the writers to format their interventions in some way. Usually through BBcode or markdown. This library proposes to use the LaTeX syntax to achieve this goal. The advantages are multiple. First of all LaTeX is a well established language; either the user already knows it, either he wins something more than being able to post on a website by learning it.  Second the content can easily be converted into true LaTeX by providing a good header. Third the syntax is very easy to learn as there are only four constructs, namely commands, environments and math expressions (inlined or in display-mode)."
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ast"; "Lexer"; "Parser"; "Preset"];
                      lib_pack = false;
               ...
               Library
                 ({
                     cs_name = "ocaml-latexmarkup-eliom";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "ocaml-latexmarkup";
                      lib_findlib_name = Some "eliom";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Doc
                 ({
                     cs_name = "ocaml-latexmarkup_api";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      doc_title = "AYI reference for ptarray";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.7";
     oasis_digest =
       Some "\195\218\172\028\012U\183\165\175\175\0219\244\219~\141";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
